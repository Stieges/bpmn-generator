...
| Strukturelle Validierung durchführen | serviceTask | Reviewer Agent: Führt 36 Regeln in 5 Schichten aus. Soundness (S01-S15): Start/End-Events, Edge-Referenzen, Gateway-Balance, Boundary-Events. Style (M01-M10): Naming-Konventionen, Label-Vollständigkeit. Pragmatik (P01-P03): Komplexitätsmetriken. Workflow-Net (WF01-WF03): Petri-Net-Soundness, opt-in. Optimization (O01-O04): Redesign-Hinweise, nur im optimize/soll-Modus. Profile konfigurierbar (default/strict). |
